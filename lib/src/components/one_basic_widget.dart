...
class OneBasicWidget extends StatelessWidget {
  ...
  const OneBasicWidget({Key key, @required this.child, this.type = OneBasicWidgetTypes.unknown, this.isBackButtonDismissible, this.onClickBackButtonDismissCallback})
      : assert(child != null),
        super(key: key);
